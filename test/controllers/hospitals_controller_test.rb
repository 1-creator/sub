...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post hospitals_url, params: { hospital: { description: @hospital.description, name: @hospital.name, picture: @hospital.picture } }
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { description: @hospital.description, name: @hospital.name, picture: @hospital.picture } }
